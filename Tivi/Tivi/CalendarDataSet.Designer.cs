...
namespace Tivi {
    ...
    public partial class CalendarDataSet : global::System.Data.DataSet {
        ...
        public partial class EventDataTable : global::System.Data.TypedTableBase<EventRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EventRow AddEventRow(string Description, System.DateTime Date, string Type) {
...
namespace Tivi.CalendarDataSetTableAdapters {
    ...
    public partial class EventTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Event] WHERE (([EventId] = @Original_EventId) AND ([Descriptio" +
                "n] = @Original_Description) AND ([Date] = @Original_Date) AND ([Type] = @Origina" +
                "l_Type))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Event] ([Description], [Date], [Type]) VALUES (@Description, @" +
                "Date, @Type);\r\nSELECT EventId, Description, Date, Type FROM Event WHERE (EventId" +
                " = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Event] SET [Description] = @Description, [Date] = @Date, [Type] = @Type WHERE (([EventId] = @Original_EventId) AND ([Description] = @Original_Description) AND ([Date] = @Original_Date) AND ([Type] = @Original_Type));
SELECT EventId, Description, Date, Type FROM Event WHERE (EventId = @EventId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Tivi.Properties.Settings.Default.CalendarConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EventId, Description, Date, Type FROM dbo.Event";
        ...
        public virtual int Delete(int Original_EventId, string Original_Description, System.DateTime Original_Date, string Original_Type) {
        ...
        public virtual int Insert(string Description, System.DateTime Date, string Type) {
            if ((Description == null)) {
        ...
        public virtual int Update(string Description, System.DateTime Date, string Type, int Original_EventId, string Original_Description, System.DateTime Original_Date, string Original_Type, int EventId) {
            if ((Description == null)) {
                throw new global::System.ArgumentNullException("Description");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Description, System.DateTime Date, string Type, int Original_EventId, string Original_Description, System.DateTime Original_Date, string Original_Type) {
            return this.Update(Description, Date, Type, Original_EventId, Original_Description, Original_Date, Original_Type, Original_EventId);
        }
    }
